package com.pi4j.example.gpio.analog.inputtooutput;
...
public class AnalogInputSyncToOutputExample {
    ...
    public static final int ANALOG_OUTPUT_PIN = 5;
    ...
    public static void main(String[] args) throws Exception {
        ...
        var output = pi4j.analogOutput().create(ANALOG_OUTPUT_PIN);
        ...
        output.addListener(console::println);
